'Plot Energy vs Displacement from EvsDist file'
import numpy as np
import math
import matplotlib.pyplot as plt


filename = '/Users/valinor/Desktop/Projects/MachineLearningAppliedToDisplacementEnergies/Data/Final/Monoatomic/monoatom_Ed_avg_all.csv'
Matrix = []
xyz = open(filename, "r")
for line in xyz:
...
def fit1(density,E_ioniz,l_bond):
    ed = 1.296178732584652e+01 + 2.729416958744306e+02 * ((float(density) / float(E_ioniz)) / (float(l_bond)**3))
    return ed
...
#with package
#r_squared = round(r2_score(ed_exp, ed_predict),4)
